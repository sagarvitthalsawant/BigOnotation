...
public class BigONotation {
    ...
    public static void main(String[] args) {
        ...
        BigONotation testAlgo2 = new BigONotation(100);
        testAlgo2.generateRandomArray();

        BigONotation testAlgo3 = new BigONotation(200);
        testAlgo3.generateRandomArray();

        BigONotation testAlgo4 = new BigONotation(300);
        testAlgo4.generateRandomArray();

        BigONotation testAlgo5 = new BigONotation(400);
        ...
        /*0(1) Test*//*
         ...
         /*O(N) Test*/
            /*testAlgo2.linearSearchForValue(21);
            testAlgo3.linearSearchForValue(21);
            testAlgo4.linearSearchForValue(21);
            testAlgo5.linearSearchForValue(21);*/
        ...
        // O(N^2) Test
         ...
         // 0 (log N) Test
            /*testAlgo2.binarySearchForValue(21);
            testAlgo3.binarySearchForValue(21);*/
